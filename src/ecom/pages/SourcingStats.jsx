    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">{tp('Chargement des statistiques...')}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex items-center gap-4">
            <button onClick={() => navigate('/ecom/sourcing')} aria-label={tp('Retour au sourcing')} className="p-2 -ml-2 rounded-lg hover:bg-gray-100 active:scale-95 text-gray-400 hover:text-gray-900 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-1">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1 font-medium">{tp('Vue d\'ensemble complète des commandes et paiements')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <section aria-labelledby="toplan-title">
          <h2 id="toplan-title" className="text-base font-bold text-gray-900 mb-3 flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-400">{tp('(commandes en transit, impayées)')}</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <div className="flex items-center justify-between mb-3">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">{tp('Chine')}</p>
              ...
              <div className="space-y-1.5 pt-3 border-t border-gray-100">
                <div className="flex justify-between text-xs font-medium">
                  <span className="text-gray-500">{tp('Achat')}</span>
                  <span className="text-gray-900 tabular-nums">{formatMoney(toPlan.china.purchase)}</span>
                </div>
                <div className="flex justify-between text-xs font-medium">
                  <span className="text-gray-500">{tp('Transport')}</span>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <div className="flex items-center justify-between mb-3">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">{tp('Local')}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section aria-labelledby="china-title" className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-3 pt-4 border-t border-gray-100">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">{tp('Achat Chine')}</p>
              ...
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide pt-2">{tp('Transport')}</p>
          ...
          <section aria-labelledby="local-title" className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-3 pt-4 border-t border-gray-100">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">{tp('Montants')}</p>

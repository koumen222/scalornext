...
const ClassicPreview = () => (
  <div className="p-2 bg-card rounded-xl">
    <div className="flex justify-between mb-2 pb-1.5 border-b border-border">
    ...
    <div className="grid grid-cols-2 gap-1.5">
      <div>
        ...
        <div className="flex gap-1 mt-1">{[1,2,3,4].map(i => <div key={i} className={`flex-1 pb-[100%] rounded ${i===1?'bg-violet-100 border border-violet-300':'bg-muted'}`} />)}</div>
      </div>
...
const LandingPreview = () => (
  <div className="p-2 bg-card rounded-xl">
    ...
    <div className="flex gap-1">{[1,2,3].map(i => <div key={i} className="flex-1 p-1.5 rounded bg-background text-center"><div className="w-2.5 h-2.5 rounded-full bg-violet-200 mx-auto mb-1" /><div className="w-[80%] h-1 rounded bg-gray-200 mx-auto" /></div>)}</div>
  </div>
);
...
const MagazinePreview = () => (
  <div className="p-2 bg-card rounded-xl">
    ...
    <div className="grid grid-cols-2 gap-1.5">
      {/* Image + thumbnails */}
      <div>
        <div className="pb-[90%] rounded-lg bg-muted relative overflow-hidden">
...
const MinimalPreview = () => (
  <div className="p-2 bg-card rounded-xl">
    ...
    <div className="pb-[50%] rounded-sm bg-background relative mb-3">
    ...
    <div className="space-y-1.5 px-1">
      ...
      <div className="w-full h-[1px] bg-muted my-2" />
...
const BoldPreview = () => (
  <div className="p-2 bg-violet-600 rounded-xl">
    <div className="flex justify-between mb-2 pb-1.5 border-b border-white/20">
      ...
      <div className="flex gap-1">{[1,2,3].map(i => <div key={i} className="w-1 h-1 rounded-full bg-card/50" />)}</div>
    </div>
    <div className="pb-[40%] rounded-xl bg-card/10 relative mb-2 overflow-hidden">
    ...
    <div className="space-y-1 px-0.5">
      <div className="w-[80%] h-2 rounded bg-card/90" />
      <div className="w-[60%] h-1 rounded bg-card/40" />
      <div className="flex gap-1 items-center mt-1"><div className="w-10 h-2.5 rounded bg-yellow-400" /><div className="w-6 h-1.5 rounded bg-card/30 line-through" /></div>
...
const ClassicStorePreview = () => (
  <div className="p-1.5 bg-card rounded-xl">
    <div className="h-5 rounded bg-background flex items-center px-1.5 mb-1.5 gap-1">
    ...
    <div className="grid grid-cols-3 gap-1">
      {[1,2,3].map(i => (
        <div key={i} className="rounded bg-background">
          <div className="pb-[75%] rounded-t bg-muted relative"><div className="absolute inset-0 flex items-center justify-center"><Image size={8} className="text-gray-300" /></div></div>
  ...
  <div className="p-1.5 bg-card rounded-xl">
    ...
    <div className="pb-[40%] rounded-lg bg-gradient-to-br from-violet-600 to-violet-800 relative mb-1.5 overflow-hidden">
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-1">
        <div className="w-[60%] h-1.5 rounded bg-card/80" />
        <div className="w-[40%] h-1 rounded bg-card/40" />
        <div className="w-8 h-2.5 rounded-full bg-card mt-1" />
      </div>
    </div>
    <div className="flex gap-1">
      {[1,2,3].map(i => (
        <div key={i} className="flex-1 rounded bg-background overflow-hidden">
          <div className="pb-[100%] bg-muted relative"><div className="absolute inset-0 flex items-center justify-center"><Image size={7} className="text-gray-300" /></div></div>
  ...
  <div className="p-1.5 bg-card rounded-xl">
    <div className="pb-[50%] rounded-lg bg-gradient-to-b from-gray-800 to-gray-900 relative mb-1.5 overflow-hidden">
      <div className="absolute top-1 left-1.5 right-1.5 flex justify-between z-10">
        <div className="w-4 h-0.5 rounded bg-card/60" />
        <div className="flex gap-0.5">{[1,2].map(i => <div key={i} className="w-1 h-1 rounded-full bg-card/40" />)}</div>
      </div>
      ...
      <div className="absolute bottom-1.5 left-1.5 right-1.5">
        <div className="w-[70%] h-1 rounded bg-card/80 mb-0.5" />
        <div className="w-[45%] h-0.5 rounded bg-card/40" />
      </div>
    </div>
    <div className="grid grid-cols-2 gap-1">
      {[1,2].map(i => (
        <div key={i} className="rounded bg-background overflow-hidden">
          <div className="pb-[65%] bg-gray-200 relative"><div className="absolute inset-0 flex items-center justify-center"><Image size={8} className="text-muted-foreground" /></div></div>
        </div>
      ))}
    </div>
  </div>
...
const MinimalStorePreview = () => (
  <div className="p-1.5 bg-card rounded-xl">
    ...
    <div className="grid grid-cols-3 gap-1 mb-1.5">
      {[1,2,3].map(i => (
        <div key={i} className="rounded-sm bg-background">
          <div className="pb-[100%] bg-muted relative"><div className="absolute inset-0 flex items-center justify-center"><Image size={7} className="text-gray-200" /></div></div>
...
const BoldStorePreview = () => (
  <div className="p-1.5 bg-violet-600 rounded-xl">
    <div className="h-5 flex items-center justify-between border-b border-white/20 mb-1.5">
      ...
      <div className="flex gap-0.5">{[1,2,3].map(i => <div key={i} className="w-1 h-1 rounded-full bg-card/40" />)}</div>
    </div>
    <div className="pb-[30%] rounded-lg bg-card/10 relative mb-1.5 overflow-hidden">
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-0.5">
        <div className="w-[55%] h-1.5 rounded bg-card/90" />
        <div className="w-[35%] h-1 rounded bg-card/40" />
        <div className="w-8 h-2.5 rounded-xl bg-yellow-400 mt-0.5" />
      </div>
    </div>
    <div className="grid grid-cols-3 gap-1">
      {[1,2,3].map(i => (
        <div key={i} className="rounded-lg bg-card/10 overflow-hidden">
          ...
          <div className="px-0.5 pb-1"><div className="w-full h-0.5 rounded bg-card/60" /></div>
        </div>
      ))}
    </div>
  </div>
  ...
  <div>
    ...
    <div className="flex items-center gap-2">
      <input type="color" value={value || '#000000'} onChange={e => onChange(e.target.value)}
        className="w-9 h-9 rounded-lg border border-border cursor-pointer appearance-none bg-transparent p-0.5" />
      <input type="text" value={value || ''} onChange={e => onChange(e.target.value)}
        className="flex-1 px-3 py-2 rounded-lg border border-border text-xs font-mono focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-200" />
    </div>
  </div>
);
  ...
  return (
    <div
      className={`flex items-center justify-between gap-4 rounded-2xl border px-4 py-3 transition-all duration-200 ${
        value ? 'bg-card shadow-sm' : 'bg-background/80 hover:bg-card'
      }`}
      style={{
    ...
    >
      <div className="min-w-0 pr-2">
        <div className="flex items-center gap-2">
          ...
          <span
            className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-[0.16em] ${
              value ? 'text-foreground' : 'bg-gray-200 text-muted-foreground'
            }`}
        ...
        {desc && <p className="mt-1 text-[11px] leading-5 text-muted-foreground">{desc}</p>}
      </div>
      ...
      >
        <span
          className={`absolute inset-y-0.5 flex w-7 items-center justify-center rounded-full bg-card text-[10px] font-extrabold text-foreground shadow-[0_6px_14px_-8px_rgba(15,23,42,0.5)] transition-all duration-200 ${
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-foreground tracking-tight">Thème Page Produit</h1>
                <p className="text-[11px] sm:text-xs text-muted-foreground">Personnalisez l'apparence de vos pages produits</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              {getActiveStorefrontUrl() && (
                <a href={getActiveStorefrontUrl()} target="_blank" rel="noopener noreferrer"
                  className="hidden sm:flex items-center gap-1.5 rounded-xl border border-border bg-card px-3 py-2 text-xs font-medium text-muted-foreground transition hover:bg-background">
              ...
              {hasChanges && (
                <button
                  ...
                  className="rounded-xl border border-border bg-card px-4 py-2.5 text-sm font-medium text-muted-foreground transition hover:bg-background"
                >
                  Annuler
                </button>
              )}
              <button onClick={handleSave} disabled={saving || !hasChanges}
                className={`flex items-center gap-1.5 rounded-xl px-5 py-2.5 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-50 ${
                  saved ? 'bg-primary' : hasChanges ? 'bg-primary-700 hover:bg-primary-800' : 'bg-gray-300'
                }`}>
              ...
              return (
                <button key={s.id} onClick={() => { setActiveSection(s.id); setSearchParams({ tab: s.id }); }}
                  className={`flex items-center gap-1.5 whitespace-nowrap rounded-lg px-3 py-2 text-xs font-medium transition ${
                    isActive ? 'bg-primary-50 text-primary' : 'text-muted-foreground hover:bg-background hover:text-foreground'
                  }`}>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        {activeSection === 'layout' && (
          <div className="space-y-6">
            <div>
              <h2 className="mb-1 text-base font-bold text-foreground">Mise en page</h2>
              <p className="text-sm text-muted-foreground">Choisissez le thème de votre boutique</p>
            </div>
                ...
                return (
                  <button key={theme.id} type="button" onClick={() => handleSelect(theme.id)}
                    className={`group overflow-hidden rounded-[22px] border text-left transition-all duration-200 ${
                      isSelected ? 'border-primary-500 bg-card shadow-[0_22px_44px_-26px_rgba(16,24,40,0.24)] ring-1 ring-primary-100' : 'border-border bg-card hover:-translate-y-0.5 hover:border-gray-300 hover:shadow-[0_18px_34px_-26px_rgba(16,24,40,0.2)]'
                    }`}>
                    <div className={`relative px-2 pt-2 ${isSelected ? 'bg-gradient-to-b from-primary-50/70 to-white' : 'bg-gradient-to-b from-gray-50 to-white'}`}>
                      {isSelected && (
                        <div className="absolute right-3 top-3 z-10 flex h-7 w-7 items-center justify-center rounded-full bg-primary shadow-[0_10px_18px_-10px_rgba(5,150,105,0.7)]">
                          <Check size={14} color="#fff" strokeWidth={3} />
                        </div>
                      )}
                      <div className={`overflow-hidden rounded-2xl border ${isSelected ? 'border-primary-100 bg-card shadow-sm' : 'border-border bg-card'}`}>
                        <Preview />
                      </div>
                    </div>
                    <div className="bg-card px-4 pb-4 pt-3">
                      <div className="mb-1 flex items-center gap-2">
                        <span className={`flex h-7 w-7 items-center justify-center rounded-full ${isSelected ? 'bg-primary-50 text-primary' : 'bg-background text-muted-foreground'}`}>
                          <ThemeIcon size={14} />
                        </span>
                        <span className={`text-[15px] font-semibold tracking-tight ${isSelected ? 'text-primary' : 'text-foreground'}`}>{theme.name}</span>
                      </div>
                      <span className={`inline-flex rounded-full px-2 py-1 text-[9px] font-semibold uppercase tracking-wide ${isSelected ? 'bg-primary-50 text-primary' : 'bg-muted text-muted-foreground'}`}>{theme.badge}</span>
                      <p className="mt-2 text-[12px] leading-5 text-muted-foreground">{theme.desc}</p>
                    </div>
                  </button>
                );
              })}
              ...
              <div className="relative overflow-hidden rounded-3xl border border-amber-200 bg-gradient-to-br from-amber-50 via-white to-orange-50 p-6 shadow-sm">
                ...
                <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="text-base font-black text-foreground">Générer une page Pro avec l'IA</h3>
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {['Hero split premium', 'Preuves sociales', 'Témoignages', 'Section science', 'Comparaison'].map((f) => (
                          <span key={f} className="inline-flex items-center gap-1 rounded-full border border-amber-200 bg-card px-2.5 py-1 text-[10px] font-semibold text-amber-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
                <h3 className="mb-3 flex items-center gap-2 text-sm font-semibold text-foreground"><Image size={15} className="text-primary" /> Ratio des images</h3>
                <div className="grid grid-cols-2 gap-2">
                  {IMAGE_RATIOS.map(r => (
                    <button key={r.id} onClick={() => updateDesign('imageRatio', r.id)}
                      className={`rounded-xl border p-3 text-left transition ${design.imageRatio === r.id ? 'border-primary-500 bg-primary-50' : 'border-border hover:border-gray-300'}`}>
                      <span className="text-xs font-semibold text-foreground">{r.name}</span>
                      <span className="block text-[10px] text-muted-foreground mt-0.5">{r.ratio}</span>
                    </button>
                  ))}
                </div>
              </div>
              <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
                <h3 className="mb-3 flex items-center gap-2 text-sm font-semibold text-foreground"><Rows3 size={15} className="text-primary" /> Espacement</h3>
                <div className="grid grid-cols-3 gap-2">
                  {SPACING_OPTIONS.map(s => (
                    <button key={s.id} onClick={() => updateDesign('spacing', s.value)}
                      className={`rounded-xl border p-3 text-center transition ${design.spacing === s.value ? 'border-primary-500 bg-primary-50' : 'border-border hover:border-gray-300'}`}>
        ...
        {activeSection === 'colors' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-base font-extrabold text-foreground mb-1">Palette de couleurs</h2>
              <p className="text-sm text-muted-foreground">Sélectionnez un preset ou personnalisez chaque couleur</p>
            </div>
              ...
              {[{ id: 'presets', label: 'Presets', icon: Palette }, { id: 'custom', label: 'Personnaliser', icon: Droplets }].map(t => {
                ...
                return (
                  <button key={t.id} onClick={() => setColorTab(t.id)}
                    className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold transition ${isActive ? 'bg-card text-violet-700 shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}>
                  ...
                  {COLOR_PRESETS.map(p => {
                    ...
                    return (
                      <button key={p.id} type="button" onClick={() => applyColorPreset(p)}
                        className={`flex items-center gap-3 p-3 rounded-xl border-2 transition text-left ${isActive ? 'border-violet-500 bg-violet-50 shadow-sm' : 'border-border hover:border-gray-300 bg-card'}`}>
                        <div className={`w-10 h-10 rounded-full border-2 shrink-0 shadow-sm ${isActive ? 'border-violet-500 ring-2 ring-violet-200' : 'border-border'}`}
                          style={{ background: `linear-gradient(135deg, ${p.accent} 50%, ${p.bg} 50%)` }} />
                        <div className="min-w-0">
                          <span className={`block text-xs font-bold truncate ${isActive ? 'text-violet-700' : 'text-foreground'}`}>{p.name}</span>
                          <div className="flex gap-1 mt-1">
                            <div className="w-3 h-3 rounded-full border border-border" style={{ background: p.accent }} />
                            <div className="w-3 h-3 rounded-full border border-border" style={{ background: p.bg }} />
                            <div className="w-3 h-3 rounded-full border border-border" style={{ background: p.badge }} />
                          </div>
                        </div>
            ...
            {colorTab === 'custom' && (
              <div className="space-y-5">
                <div className="bg-card rounded-2xl border p-5">
                  <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4">Couleurs globales</h3>
                ...
                <div className="bg-card rounded-2xl border p-5">
                  <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4">Couleurs des sections</h3>
        ...
        {activeSection === 'typo' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-base font-extrabold text-foreground mb-1">Typographie</h2>
              <p className="text-sm text-muted-foreground">Police, taille et poids du texte</p>
            </div>

            <div className="bg-card rounded-2xl border p-5">
              <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4">Police</h3>
                  ...
                  return (
                    <button key={f.id} type="button" onClick={() => updateDesign('fontFamily', f.id)}
                      className={`px-4 py-3 rounded-xl border-2 text-left transition ${
                        isActive ? 'border-violet-500 bg-violet-50 shadow-sm' : 'border-border hover:border-gray-300 bg-card'
                      }`}>
                      <span className="block text-base font-bold text-foreground" style={{ fontFamily: f.family }}>{f.name}</span>
                      <span className="block text-[11px] text-muted-foreground mt-0.5" style={{ fontFamily: f.family }}>Aperçu du texte 123</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-card rounded-2xl border p-5">
                <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3">Taille de base</label>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-foreground bg-muted px-3 py-1 rounded-lg">{design.fontBase}px</span>
                </div>
                <p className="text-[11px] text-muted-foreground mt-2">Affecte la taille du texte de base</p>
              </div>
              <div className="bg-card rounded-2xl border p-5">
                <label className="block text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3">Poids des boutons</label>
                <select value={design.fontWeight} onChange={e => updateDesign('fontWeight', e.target.value)}
                  className="w-full px-4 py-2.5 rounded-xl border border-border text-sm focus:outline-none focus:border-violet-400 focus:ring-1 focus:ring-violet-200 bg-card">
        ...
        {activeSection === 'buttons' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-base font-extrabold text-foreground mb-1">Boutons & Styles</h2>
              <p className="text-sm text-muted-foreground">Forme, style et apparence des boutons et badges</p>
            </div>

            <div className="bg-card rounded-2xl border p-5">
              <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4">Style des boutons</h3>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {BUTTON_STYLES.map(b => {
                  const isActive = design.buttonStyle === b.id;
                  return (
                    <button key={b.id} onClick={() => updateDesign('buttonStyle', b.id)}
                      className={`p-4 rounded-xl border-2 transition ${isActive ? 'border-violet-500 bg-violet-50' : 'border-border hover:border-gray-300'}`}>
                      ...
                      <span className="block text-[10px] text-muted-foreground mt-0.5">{b.desc}</span>
                    </button>
                  );
                })}
              </div>
            ...
            <div className="bg-card rounded-2xl border p-5">
              <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4">Bordures</h3>
                ...
                {BORDER_STYLES.map(b => {
                  ...
                  return (
                    <button key={b.id} type="button" onClick={() => updateDesign('borderRadius', b.radius)}
                      ...
                      <span className={`text-xs font-bold ${isActive ? 'text-violet-700' : 'text-muted-foreground'}`}>{b.name}</span>
                    </button>
                  );
                })}
              </div>
            ...
            <div className="bg-card rounded-2xl border p-5">
              <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4">Style des badges promo</h3>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {BADGE_STYLES.map(b => {
                  ...
                  return (
                    <button key={b.id} onClick={() => updateDesign('badgeStyle', b.id)}
                      className={`p-4 rounded-xl border-2 transition flex flex-col items-center gap-2 ${isActive ? 'border-violet-500 bg-violet-50' : 'border-border hover:border-gray-300'}`}>
                      {bdg}
                      <span className="text-xs font-bold text-foreground">{b.name}</span>
                    </button>
                  );
        ...
        {activeSection === 'elements' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-base font-extrabold text-foreground mb-1">Éléments de la page</h2>
              <p className="text-sm text-muted-foreground">Activez ou désactivez les sections de votre page produit</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-card rounded-2xl border p-5 space-y-3">
                <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2"><ShoppingBag size={14} /> Achat</h3>
              ...
              <div className="bg-card rounded-2xl border p-5 space-y-3">
                <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2"><Shield size={14} /> Confiance</h3>
              ...
              <div className="bg-card rounded-2xl border p-5 space-y-3">
                <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2"><Layout size={14} /> Contenu</h3>
        ...
        {activeSection === 'infographics' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-base font-extrabold text-foreground mb-1">Page Infographies</h2>
              <p className="text-sm text-muted-foreground">Personnalisez l'apparence et les textes du template Infographies (thème "infographics")</p>
            </div>

            <div className="bg-card rounded-2xl border p-5 space-y-5">
              <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2"><Layers size={14} /> Couleurs du bouton sticky</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <ColorInput
              ...
              <div>
                <label className="block text-[10px] font-semibold text-muted-foreground mb-2 uppercase tracking-wider">Taille du bouton sticky</label>
                <div className="flex gap-2">
                  {[{ id: 'small', label: 'Petit' }, { id: 'medium', label: 'Moyen' }, { id: 'large', label: 'Grand' }].map(opt => (
                    <button key={opt.id} type="button"
                      ...
                      className={`flex-1 py-2.5 rounded-xl border-2 text-xs font-bold transition ${infographicsForm.buttonSize === opt.id ? 'border-primary-500 bg-primary-50 text-primary' : 'border-border text-muted-foreground hover:border-gray-300'}`}>
                      {opt.label}
                    </button>
                  ))}
                </div>
            ...
            <div className="bg-card rounded-2xl border p-5 space-y-4">
              <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-2"><MessageCircle size={14} /> Textes du formulaire</h3>
              {[
                ...
                <div key={field.key}>
                  <label className="block text-[10px] font-semibold text-muted-foreground mb-1.5 uppercase tracking-wider">{field.label}</label>
                  <input
                    type="text"
                    value={infographicsForm[field.key] || ''}
                    placeholder={field.placeholder}
                    onChange={e => { setInfographicsForm(p => ({ ...p, [field.key]: e.target.value })); setSaved(false); }}
                    className="w-full px-3 py-2 rounded-xl border border-border text-sm focus:outline-none focus:border-primary-400 focus:ring-1 focus:ring-primary-200"
                  />
                </div>
              ))}
            </div>
        ...
        {activeSection === 'preview' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-base font-extrabold text-foreground mb-1">Aperçu en direct</h2>
              <p className="text-sm text-muted-foreground">Visualisez le rendu de votre page produit</p>
            </div>
            ...
            <div className="bg-card rounded-2xl border overflow-hidden">
              ...
              <div className="px-3 py-2 bg-muted border-b border-border flex items-center gap-2">
                ...
                <div className="flex-1 mx-8 bg-card rounded-md px-3 py-1 text-[10px] text-muted-foreground text-center border border-border">
              ...
              {currentTheme === 'magazine' ? (
                ...
                <div style={{ backgroundColor: '#fff', fontFamily }}>
                  ...
                  <div className="grid grid-cols-2 gap-6 p-5 sm:p-7" style={{ alignItems: 'start' }}>
                    ...
                    <div>
                      <div className="relative rounded-xl overflow-hidden bg-background" style={{ paddingBottom: '100%' }}>
                      ...
                      <div className="flex gap-1.5 mt-2">
                        {[1,2,3,4].map(i => (
                          <div key={i} className="flex-1 rounded-lg bg-muted" style={{ paddingBottom: '100%', border: i===1 ? `2px solid ${design.buttonColor}` : '2px solid transparent' }} />
                        ))}
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center gap-1.5 mb-2">
                        ...
                        <span className="text-xs font-bold text-muted-foreground">4,9/5 · +1 000 clients</span>
                      </div>
                      ...
                      <div className="flex items-baseline gap-2 mb-3">
                        ...
                        <span className="text-sm line-through text-muted-foreground">42 000 FCFA</span>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-x-3 gap-y-1">
                        {['Paiement livraison', 'Livraison rapide', 'WhatsApp'].map((r, i) => (
                          <span key={i} className="flex items-center gap-1 text-[10px] font-bold text-muted-foreground">
                      ...
                      <div className="mt-3 space-y-1.5">
                        {['Comment ca marche ?', 'Ingredients cles', 'Garantie satisfait'].map((acc, i) => (
                          <div key={i} className="border border-border rounded-xl overflow-hidden">
                            <div className="flex items-center justify-between px-3 py-2.5 text-xs font-extrabold text-foreground">
                              <span>{acc}</span>
                  ...
                  <div className="px-5 py-3 border-t border-border flex gap-6 overflow-hidden" style={{ background: '#EFF8F7' }}>
                    ...
                    <div>
                      <div className="pb-[100%] rounded-xl bg-gradient-to-br from-gray-100 to-gray-50 relative overflow-hidden"
                        ...
                        {design.showStockIndicator && (
                          <div className="absolute bottom-3 left-3 flex items-center gap-1.5 bg-card/90 backdrop-blur px-2.5 py-1 rounded-full">
                      ...
                      <div className="flex gap-2 mt-3">
                        {[1,2,3,4].map(i => (
                          <div key={i} className="flex-1 pb-[100%] bg-muted"

      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-green-900 to-gray-900 flex items-center justify-center p-4">
        <div className="w-full max-w-lg bg-gray-800 rounded-2xl p-8 shadow-2xl border border-gray-700">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">{tp('Votre clé API')}</h2>
            <p className="text-yellow-400 text-sm mt-2">{tp('⚠️ Sauvegardez cette clé maintenant. Elle ne sera plus affichée.')}</p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-green-900 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-800 rounded-2xl p-8 shadow-2xl border border-gray-700">
          <h2 className="text-xl font-semibold text-white mb-6">{tp('Inscription')}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? 'Création...' : tp('Créer mon compte')}
            </button>
          </form>

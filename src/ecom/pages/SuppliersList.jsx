    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Fournisseurs & Logistique</h1>
            <p className="mt-1 text-sm text-muted-foreground">{tp('Gérez vos commandes fournisseurs')}</p>
          </div>
          <button
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-card placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-primary-600 focus:border-primary-600 sm:text-sm"
            />
          </div>
        </div>
            ...
            {suppliers.map((supplier, index) => (
              ...
              >
                ...
                <div className="mt-4 pt-4 border-t border-border">
                  <button className="w-full text-center px-3 py-2 text-sm font-medium text-primary bg-primary-50 rounded-lg hover:bg-primary-100 transition-colors">
                    Voir les commandes →
                  </button>
                </div>
              </div>

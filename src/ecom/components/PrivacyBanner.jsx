        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div className="flex items-start gap-3 flex-1">
              <div className="flex-shrink-0 w-10 h-10 bg-primary/20 border border-primary-600/30 rounded-xl flex items-center justify-center">
            ...
            <div className="flex items-center gap-2 flex-shrink-0 w-full sm:w-auto">
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2 text-xs font-medium text-muted-foreground hover:text-white bg-card/5 hover:bg-card/10 border border-white/10 rounded-lg transition"
              >
                {tp('Refuser')}
              </button>
              <button

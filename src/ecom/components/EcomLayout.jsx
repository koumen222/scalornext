...
const EcomLayoutComponent = ({ children }) => {
  ...
  const mainNav = useMemo(() => [
    ...
    {
      name: 'Centre de contrôle', shortName: 'Pilotage', href: '/ecom/centre-controle', primary: true,
      roles: ['ecom_admin', 'ecom_closeuse', 'ecom_compta'],
      icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h5M7 17h7" /></svg>
    },
    {
  ...
  const secondaryNav = useMemo(() => [
    {
      name: 'Gestion de stock', shortName: 'Stock', href: '/ecom/stock', primary: false,
      roles: ['ecom_admin', 'ecom_closeuse'],
      icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
    },
    {
    ...
    {
      name: 'Formation', shortName: 'Formation', href: '/ecom/formation', primary: false,
      roles: ['ecom_admin', 'ecom_closeuse', 'ecom_compta'],
  ...
  const superAdminNav = useMemo(() => [
    ...
    {
      name: 'Service Client', shortName: 'Service', href: '/ecom/service-client', primary: true,
    ...
    {
      name: 'Features', shortName: 'Features', href: '/ecom/super-admin/feature-analytics', primary: true,
      roles: ['super_admin'],
      icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
    },
    {
      name: 'Pages IA', shortName: 'Pages IA', href: '/ecom/super-admin/product-page-history', primary: true,
      roles: ['super_admin'],
    ...
    {
      name: 'Gestion des plans', shortName: 'Plans', href: '/ecom/super-admin/plans', primary: true,
      roles: ['super_admin'],
    ...
    {
      name: 'Email Analytics', shortName: 'Email', href: '/ecom/marketing/analytics', primary: true,
      roles: ['super_admin'],
    ...
    {
      name: 'Affiliation', shortName: 'Affiliés', href: '/ecom/affiliates', primary: true,
      roles: ['super_admin'],
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-[220px] lg:fixed lg:inset-y-0 z-30 bg-white border-r border-gray-200">
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto">
            {useAdminLayout ? (
              <>
                <p className="px-2 pt-1 pb-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">{isSuperAdmin ? 'Administration' : 'Service Client'}</p>
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-1 w-56 rounded-xl shadow-xl border overflow-hidden z-50 bg-white border-gray-200">
                  <div className="px-4 py-3 border-b border-gray-100">
                    ...
                    {isServiceClient && <span className="inline-block text-[10px] font-bold text-blue-600 uppercase tracking-wider mt-1">Service Client</span>}
                  </div>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-[#25D366]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-white font-bold text-base leading-tight">Rejoignez le support</h2>
                  <p className="text-white/80 text-xs">Communauté Scalor sur WhatsApp</p>
                </div>
              </div>
            ...
            <div className="px-6 py-6 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Rejoignez notre groupe support</h3>
...
const getPageTitle = (pathname) => {
  ...
  if (pathname.includes('/centre-controle')) return 'Centre de contrôle';
  ...
  if (pathname.includes('/super-admin/product-page-history')) return 'Historique pages produit';
  ...
  if (pathname.includes('/affiliates')) return 'Programme Affiliation';
  return 'Scalor';
};

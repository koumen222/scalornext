...
const MontageStudio = ({ importedProduct, onImport, onClearImport, credits, onCreditsChange, onNeedCredits }) => {
  ...
  const startRender = async (list, ov = {}) => {
    ...
    if (typeof credits === 'number' && credits < featureCost('montage')) { onNeedCredits?.(); return; }

...
import { ACCENTS, StudioHeader, Field, downloadFile, ImportProductBar, stripHtml, LoadingBar } from './creativeShared.jsx';
...
const VideoStudio = ({ importedProduct, onImport, onClearImport, onSendToMontage }) => {

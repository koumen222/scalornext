...
// URL publique courte d'un code affilié ou d'un lien de campagne.
// Le middleware Next redirige /SCL… et /LNK… vers l'endpoint de tracking.
export function affiliateTrackingUrl(trackingCode) {
